...
class Config:
    ...
    def __init__(self):
        ...
        self.filtering = {
            ...
            "allowed_languages": ["en", "es", "fr", "de", "it", "ko", "vi", "zh"],  # Extended language support
        ...
        self.mood_categories = {
            ...
            "Cluster 2": ["Amiable-good natured", "Cheerful", "Fun", "Rollicking", "Sweet"],
            "Cluster 3": ["Autumnal", "Bittersweet", "Brooding", "Literate", "Poignant", "Wistful"],
            "Cluster 4": ["Campy", "Humorous", "Silly", "whimsical", "Witty", "Wry"],
            "Cluster 5": ["Agressive", "Fiery", "Intense", "Tense - Anxious", "Visceral", "Volatile"]
        }
    ...
    def create_lenient_config(cls) -> 'Config':
        ...
        config.processing.workers = min(4, config.processing.workers)  # Conservative worker count
