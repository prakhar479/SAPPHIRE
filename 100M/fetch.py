...
def get_all_h5_files(basedir):
    ...
    return [os.path.join(root, f) for root, _, files in os.walk(basedir) for f in files if f.endswith('.h5')]
    ...
    try:
        with h5py.File(file_path, 'r') as h5f:
            ...
            data = {
                ...
                'time_signature_confidence': get_scalar(song_analysis['time_signature_confidence']),
